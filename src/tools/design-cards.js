...
//   부위 이름이 헷갈리기 쉽다 — pillowF/R 이 **앞**(F=왼쪽·R=오른쪽),
//   pillowL/W 가 **뒤**(L=왼쪽·W=오른쪽)다. PARTS 의 ko 를 보고 맞출 것.
const PILLOWS = { pillowF:C.b2006, pillowR:C.d2013, pillowL:C.r2004, pillowW:C.y2010 };
